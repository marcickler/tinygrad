...
symbolic = symbolic_simple+commutative+PatternMatcher([
  ...
  ((UPat.var("x") * UPat.var("y")) * UPat.var("x"), lambda x, y: x * x * y if x is not y else None), # change order to enable square simplifications like above
  ((UPat.var("x") * UPat.var("y")) * (UPat.var("x") * UPat.var("y")), lambda x, y: x * x * y * y if x is not y else None),
