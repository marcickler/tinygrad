...
symbolic = symbolic_simple+commutative+PatternMatcher([
  ...
  (UPat.var("x") * UPat.var("y") * UPat.var("x"), lambda x, y: x * x * y), # change order to enable square simplifications like above
  ((UPat.var("x") * UPat.var("y")) * (UPat.var("x") * UPat.var("y")), lambda x, y: x * x * y * y),
